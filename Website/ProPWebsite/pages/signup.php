...
<div style="width:620px ; align-self: center; height:auto; margin: 0 auto ">
    <div style="">
...
-->
            <select  id ="ticket_type" name="ticket_type" required class="form-control input-lg" onchange="showAndHidden()">
